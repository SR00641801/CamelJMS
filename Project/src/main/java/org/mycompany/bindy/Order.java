 ...
 * @Table(name = "orders")
 * 
 * @NamedQuery(name = "new-orders", query =
 * "select order from Order order where order.processed = false") public class
 * Order {
 * 
 * @Id
 * 
 ...
 * 
 * //@Consumed public void setProcessed() { processed = true; }
 * 
